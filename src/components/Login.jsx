    ...
    return (
        <div className="flex bg-[#ccfbf1] min-h-screen items-center justify-center p-4">
            <div className="flex flex-col md:flex-row w-full max-w-5xl bg-white rounded-[40px] shadow-2xl overflow-hidden min-h-[600px] border border-white/20">
                ...
                <div className="w-full md:w-3/5 p-8 md:p-16 flex flex-col items-center justify-center relative">
                    <h2 className="text-4xl font-black text-gray-800 mb-2 mt-8 md:mt-0 tracking-tighter">Login to Your Account</h2>
                    <p className="text-gray-400 mb-8 text-sm font-medium">Login using social networks</p>
                    ...
                    <div className="flex items-center w-full max-w-sm mb-10">
                    ...
                    {/* Form */}
                    <form onSubmit={handleSignIn} className="w-full max-w-sm flex flex-col gap-5">
                ...
                <div className="w-full md:w-2/5 p-8 md:p-16 flex flex-col items-center justify-center text-center relative overflow-hidden bg-gradient-to-br from-[#12a88e] to-[#047857] text-white">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        <h2 className="text-4xl font-black mb-6 tracking-tighter">New Here?</h2>
